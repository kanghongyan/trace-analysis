...
define('echarts/component/parallel', ['require', '../coord/parallel/parallelCreator', '../coord/parallel/ParallelModel', './parallelAxis', '../echarts', 'zrender/core/util', '../coord/parallel/parallelPreprocessor'], function (require) {
...
define('echarts/chart/parallel/ParallelSeries', ['require', '../../data/List', 'zrender/core/util', '../../model/Series', '../../data/helper/completeDimensions'], function (require) {
    var List = require('../../data/List');
    var zrUtil = require('zrender/core/util');
    var SeriesModel = require('../../model/Series');
    var completeDimensions = require('../../data/helper/completeDimensions');
...
define('echarts/chart/parallel/ParallelView', ['require', '../../util/graphic', 'zrender/core/util', '../../view/Chart'], function (require) {
    ...
    var ParallelView = require('../../view/Chart').extend({
            ...
            render: function (seriesModel, ecModel, api, payload) {
                this._renderForNormal(seriesModel);    // this[
...
define('echarts/coord/parallel/Parallel', ['require', '../../util/layout', '../../coord/axisHelper', 'zrender/core/util', './ParallelAxis', '../../util/graphic', 'zrender/core/matrix'], function (require) {
    var layout = require('../../util/layout');
    var axisHelper = require('../../coord/axisHelper');
    var zrUtil = require('zrender/core/util');
...
define('echarts/component/axis/ParallelAxisView', ['require', 'zrender/core/util', './AxisBuilder', '../helper/BrushController', '../../util/graphic', '../../echarts'], function (require) {
    var zrUtil = require('zrender/core/util');
    var AxisBuilder = require('./AxisBuilder');
